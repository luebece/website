(function () {
  ...
  const moreRows = [
    ...
    ["cq-java-009", "Java", "code", "mid", "Java에서 배열 길이를 구할 때 쓰는 것은 length인가 length()인가?", ["length"], "length", "배열은 length 필드, 문자열은 length() 메서드다.", ["Java", "배열"], { answerMode: "literal" }],
    ...
    ["cq-java-012", "Java", "code", "mid", "Java에서 자식 클래스가 부모 클래스를 상속할 때 쓰는 키워드는?", ["extends"], "extends", "class Child extends Parent 형태다.", ["Java", "상속"], { answerMode: "literal" }],
    ["cq-java-013", "Java", "code", "mid", "Java에서 인터페이스를 구현할 때 쓰는 키워드는?", ["implements"], "implements", "class A implements B 형태다.", ["Java", "인터페이스"], { answerMode: "literal" }],
    ["cq-java-014", "Java", "code", "mid", "Java 출력값은?\nint[] a = {1,2};\nint[] b = a;\nb[1] = 9;\nSystem.out.print(a[1]);", ["9"], "9", "배열 참조를 공유한다.", ["Java", "배열", "참조"]],
    ["cq-java-015", "Java", "code", "mid", "Java에서 클래스가 공유하는 변수 앞에 붙는 키워드는?", ["static"], "static", "static 변수는 클래스 단위 공유값이다.", ["Java", "static"], { answerMode: "literal" }],

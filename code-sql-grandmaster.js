(function () {
  ...
  const rows = [
    ...
    ["gm-py-006", "Python", "code", "mid", "Python 리스트에서 다른 리스트의 원소들을 하나씩 풀어 뒤에 붙이는 메서드는?", ["extend"], "extend", "append는 통째로 한 칸, extend는 원소를 풀어서 추가한다.", ["Python", "리스트"], { answerMode: "literal" }],
    ...
    ["gm-py-009", "Python", "code", "mid", "Python 딕셔너리에서 key와 value 쌍을 순회할 때 자주 쓰는 메서드는?", ["items()"], "items()", "for k, v in d.items(): 형태로 쓴다.", ["Python", "dict"], { answerMode: "literal" }],
